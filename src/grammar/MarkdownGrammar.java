...
public class MarkdownGrammar extends Parser {
	...
	public final DefVarContext defVar() throws RecognitionException {
		...
		try {
			...
			setState(94);
			match(NEWLINE);
			data.Utils.defVar(variables,(((DefVarContext)_localctx).WORD!=null?((DefVarContext)_localctx).WORD.getText():null),(((DefVarContext)_localctx).any!=null?_input.getText(((DefVarContext)_localctx).any.start,((DefVarContext)_localctx).any.stop):null));
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
